      ...
      <div className="max-w-7xl mx-auto">
        <div className="text-center mb-20">
          ...
          <p className="text-lg text-neutral-600 font-light max-w-2xl mx-auto">
            Celebrating a legacy of excellence and industry recognition.
          </p>
        </div>
        ...
        <div className="bg-gradient-to-r from-amber-50 to-yellow-50 rounded-2xl p-8 md:p-12">
          <div className="grid grid-cols-1 lg:grid-cols-2 gap-12 items-center">
            <div>
              <div className="flex items-center gap-4 mb-6">
                ...
                <div>
                  ...
                  <p className="text-amber-600 font-medium">2018 Champion</p>
                </div>
              </div>
              ...
              <ul className="space-y-3">
                ...
                <li className="flex items-start gap-3">
                  <span className="w-2 h-2 bg-amber-500 rounded-full mt-2" />
                  <span className="text-neutral-600 font-light">
                    2018 Champion, XI International Championships in Decorating
                    and Nail Design
                  </span>
                </li>
              </ul>
            ...
            <div className="relative aspect-[4/3] bg-amber-100 rounded-lg overflow-hidden">
              <img
                src={`${import.meta.env.BASE_URL}images/golden-brash/golden-brash.jpeg`}
